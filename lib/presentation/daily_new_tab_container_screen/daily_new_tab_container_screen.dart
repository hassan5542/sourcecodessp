...
import 'package:hassan_s_application/presentation/daily_new_page/daily_new_page.dart';
...
import 'provider/daily_new_tab_container_provider.dart';
...
class DailyNewTabContainerScreen extends StatefulWidget {
  ...
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => DailyNewTabContainerProvider(),
...
class DailyNewTabContainerScreenState extends State<DailyNewTabContainerScreen>
  ...
  PreferredSizeWidget _buildAppBar(BuildContext context) {
    return CustomAppBar(
      title: Selector<DailyNewTabContainerProvider, TextEditingController?>(
        selector: (
          context,
          provider,
        ) =>
