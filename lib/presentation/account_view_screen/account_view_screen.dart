...
import 'provider/account_view_provider.dart';

class AccountViewScreen extends StatefulWidget {
  const AccountViewScreen({Key? key}) : super(key: key);

  @override
  AccountViewScreenState createState() => AccountViewScreenState();

  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => AccountViewProvider(), child: AccountViewScreen());
  }
}

class AccountViewScreenState extends State<AccountViewScreen> {
  @override
  void initState() {
    super.initState();
  }
