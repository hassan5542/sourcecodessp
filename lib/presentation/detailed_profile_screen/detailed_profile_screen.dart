...
import 'package:hassan_s_application/widgets/app_bar/appbar_subtitle_two.dart';
...
import 'provider/detailed_profile_provider.dart';

class DetailedProfileScreen extends StatefulWidget {
  const DetailedProfileScreen({Key? key}) : super(key: key);

  @override
  DetailedProfileScreenState createState() => DetailedProfileScreenState();

  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => DetailedProfileProvider(),
        child: DetailedProfileScreen());
  }
}

class DetailedProfileScreenState extends State<DetailedProfileScreen> {
  @override
  void initState() {
    super.initState();
  }
