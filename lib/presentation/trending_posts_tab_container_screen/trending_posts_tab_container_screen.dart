...
import 'package:hassan_s_application/presentation/discover_page/discover_page.dart';
...
import 'package:hassan_s_application/presentation/trending_posts_page/trending_posts_page.dart';
...
import 'provider/trending_posts_tab_container_provider.dart';
...
class TrendingPostsTabContainerScreen extends StatefulWidget {
  ...
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => TrendingPostsTabContainerProvider(),
...
class TrendingPostsTabContainerScreenState
  ...
  PreferredSizeWidget _buildAppBar(BuildContext context) {
    return CustomAppBar(
      title:
          Selector<TrendingPostsTabContainerProvider, TextEditingController?>(
        selector: (
          context,
          provider,
        ) =>
